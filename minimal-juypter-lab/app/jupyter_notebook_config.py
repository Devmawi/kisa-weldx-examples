...
# c.NotebookApp.password = u'sha1:49edba8891bf:babcf87e80053cb1cffab41b4eedb9c5fd7cd311'
# c.NotebookApp.token = '123'
# print("TOKEN")
# print(c.NotebookApp.token)
...
#  RECOMMENDED.
c.ServerApp.token = '' # We are very brave ;)
...
c.ServerApp.tornado_settings = {
    'headers': {
        'Content-Security-Policy': "frame-ancestors http://localhost 'self' "
    }
}
